...
if len(sys.argv) == 2 and sys.argv[1].lower() =='instructions':
    print ("python3 /home/pi/pi2_admin_tools/mcb.pyw save <keyword> - Saves clipboard to keyword.\n\n" + "python3 /home/pi/pi2_admin_tools/mcb.pyw <keyword> - Loads keyword to clipboard.\n\n" + "python3 /home/pi/pi2_admin_tools/mcb.pyw list - Loads all keywords to clipboard.\n\n")
